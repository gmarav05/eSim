...
function installDependency
{
    ...
    echo "Installing PyQt5 via apt (pip build fails on Python 3.13 + ARM64)..."
   # pip3 install PyQt5  # Commented out: no binary wheel for Python 3.13/ARM64
   # Building from source requires >4GB RAM and  qmake, both unavailable here
...
#installKicad # Commented out: libgit2-1.8 unavailable on Ubuntu 25.04
   #copyKicadLibrary # Commented out: depends on KiCad installation
   #installNghdl
    installSky130Pdk
